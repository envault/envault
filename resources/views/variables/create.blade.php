        ...
        <div class="bg-white px-4 py-5 sm:p-6 border-b border-gray-200">
            <div class="flex items-center justify-between flex-wrap sm:flex-no-wrap">
                ...
                <div>
                    ...
                    <div x-data="{ createdCount: 0, visible: false }" x-init="window.livewire.on('variables.imported', (count) => {
                                createdCount = count;
                                visible = true;
                                setTimeout(() => { visible = false }, 5000);
                            })" x-show.transition.out="visible" x-cloak role="alert">
                ...
                <span class="mt-3 flex w-full rounded-md shadow-sm sm:mt-0 sm:w-auto">
                    ...
                    <div x-show.transition.opacity="importOpen"
                        ...
                        <div @click.away="importOpen = false"
                            @keydown.escape.window="importOpen = false; $wire.set('import', '')"
                                ...
                                <div class="mt-3 text-center sm:mt-0 sm:text-left">
                                    ...
                                    <div class="mt-3 rounded-md shadow-sm">
                                        <textarea wire:model.defer="import" rows="20"
                                            ...
                                            class="shadow-sm focus:ring-indigo-500 focus:border-indigo-500 block w-full sm:text-sm border-gray-300 rounded-md transition duration-150 ease-in-out sm:leading-5 font-mono"></textarea>
                                    </div>
                                </div>
                            </div>
