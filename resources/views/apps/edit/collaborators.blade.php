                                        ...
                                        <div @click.away="open = false" @keydown.escape.window="open = false"
                                            ...
                                            <div class="bg-gray-50 px-4 py-3 sm:px-6 sm:flex sm:flex-row-reverse">
                                                <span class="flex w-full rounded-md shadow-sm sm:ml-3 sm:w-auto">
                                                    <button wire:click="updateRole({{ $collaborator->id }}, null)"
                                ...
                                <div>
                                    ...
                                    <div x-show.transition.opacity="open"
                                        ...
                                        <div @click.away="open = false" @keydown.escape.window="open = false"
                                            ...
                                            <div class="bg-gray-50 px-4 py-3 sm:px-6 sm:flex sm:flex-row-reverse">
                                                <span class="flex w-full rounded-md shadow-sm sm:ml-3 sm:w-auto">
                                                    <button wire:click="updateRole({{ $collaborator->id }}, 'admin')"
                                                        @click="open = false" type="button"
                                                        wire:loading.class="opacity-75 cursor-wait"
                                                        class="inline-flex justify-center w-full rounded-md border border-transparent px-4 py-2 bg-red-600 text-base leading-6 font-medium text-white shadow-sm hover:bg-red-500 focus:outline-none focus:border-red-700 focus:shadow-outline-red transition ease-in-out duration-150 sm:text-sm sm:leading-5">
                                                        Confirm
            ...
            <div class="w-full">
                <div class="flex rounded-md shadow-sm">
                    <select wire:model="userToAddId"
                        ...
                        <option value="{{ $collaborator->id }}">{{ $collaborator->first_name }} {{
                            $collaborator->last_name }}</option>
                        @endforeach
                    </select>
                </div>
            </div>
            <span class="mt-3 flex justify-end rounded-md sm:mt-0 sm:ml-3 sm:w-auto">
                <button wire:click="add" type="button" wire:loading.class="opacity-75 cursor-wait"
