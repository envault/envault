                    ...
                    <a href="{{ route('apps.show', ['app' => $app->id]) }}"
                        ...
                        <div class="flex items-center py-4 px-4 sm:px-6">
                            <div class="min-w-0 flex-1 flex items-center">
                                <div>
                                    <div class="text-sm leading-5 font-medium text-indigo-600 truncate">{{ $app->name }}
                                    </div>
                                    <div class="mt-2 flex items-center text-sm leading-5 text-gray-500">
                                        <x-heroicon-s-circle-stack class="flex-shrink-0 mr-1.5 h-5 w-5 text-gray-400" />
                                        <span class="truncate">{{ count($app->variables) }} {{ Str::plural('variable',
                                            count($app->variables)) }}</span>
                                    </div>
                                </div>
                            </div>
                            <div>
