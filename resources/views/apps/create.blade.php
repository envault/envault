<div class="bg-white shadow overflow-hidden rounded-lg">
    <div class="bg-white px-4 py-5 border-b border-gray-200 sm:px-6 sm:flex justify-between items-center">
        <h3 class="text-lg leading-6 font-medium text-gray-900">
            New app
        </h3>
        <a href="https://github.com/envault/laravel" target="blank"
           class="mt-1 sm:mt-0 flex items-center text-sm cursor-pointer hover:underline text-gray-900"
        >
            Install the Envault package for your app
        </a>
    </div>
