            ...
            <div class="flex-1 flex justify-between sm:justify-end">
                <div>
                    @if (!$paginator->onFirstPage())
                        <button wire:click="previousPage" type="button" wire:loading.attr="disabled" wire:loading.class="opacity-75 cursor-wait"
                ...
                <div>
                    @if ($paginator->hasMorePages())
                        <button wire:click="nextPage" type="button" wire:loading.attr="disabled" wire:loading.class="opacity-75 cursor-wait"
